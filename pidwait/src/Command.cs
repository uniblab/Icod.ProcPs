/*
	pidwait
	Wait for selected processes to terminate.
...
/// <summary>Implements procps-ng 4.0.6 <c>pidwait</c> over the shared process-matching engine.</summary>
public static class Command {
	...
	/// <summary>Runs <c>pidwait</c> synchronously.</summary>
	...
	/// <summary>Runs <c>pidwait</c> asynchronously with injectable process observation and control providers.</summary>
