...
The package does not install sixteen additional command shims. Select a ProcPs
...
sixteen historical command entry points plus `procps`, the repository `LICENSE`,
...
`ps(1)`, `pwdx(1)`, `slabtop(1)`, `hugetop(1)`, `sysctl(8)`, `top(1)`,
`uptime(1)`, `vmstat(8)`, `w(1)`, `watch(1)`
